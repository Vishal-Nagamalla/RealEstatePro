      ...
      <body className="site-geo">
        ...
        <div className="lead-strip">
          <div className="container d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
            ...
            <a className="btn btn-warning rounded-pill magnetic" href="/contact">Get My Valuation</a>
          </div>
        </div>
        ...
        <div className="float-schedule">
          <a href="/contact" className="btn btn-warning btn-lg rounded-pill magnetic">Schedule a Call</a>
        </div>
      </body>
    </html>
  );
