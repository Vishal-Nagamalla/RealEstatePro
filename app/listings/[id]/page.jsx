...
export function generateStaticParams() {
  ...
  return [...active, ...sold].map(l => ({ id: String(l.id) }));
}

// Avoid unknown params at runtime with static export
      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col md={5}>
            ...
            <p className="mt-4">
              Beautifully presented home in a sought-after neighborhood. Close to
              transit, parks, and dining.
            </p>
          </Col>
        </Row>
      </Container>
